...
import { CATEGORIES, findCategory, findSubcategory } from "./categories.js?v=18";
import { renderLog, parseLibraryTable } from "./render-log.js?v=18";
