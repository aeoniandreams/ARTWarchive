...
import { CATEGORIES, findCategory, findSubcategory } from "./categories.js?v=19";
import { renderLog, parseLibraryTable } from "./render-log.js?v=19";
