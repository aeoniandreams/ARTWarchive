...
import { CATEGORIES, findCategory, findSubcategory } from "./categories.js?v=20";
import { renderLog, parseLibraryTable } from "./render-log.js?v=20";
