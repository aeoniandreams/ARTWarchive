...
import { CATEGORIES, findCategory, findSubcategory } from "./categories.js?v=24";
import { renderLog, parseLibraryTable } from "./render-log.js?v=24";
